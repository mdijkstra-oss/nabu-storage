...
func TestCodeRouter(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input: commands.ToAny(commands.NewCommand[CreateCodePayload, any](CreateCode, CreateCodePayload{
				ProjectID: "project-1",
				Slug:      "topic:climate",
				Color:     "green-500",
			...
			expectErr: "",
			expectEvent: commands.ToAny(commands.NewDomainEvent[CreatedCodePayload, any](CreatedCode, CreatedCodePayload{
				ProjectID: "project-1",
				Slug:      "topic:climate",
				Color:     "green-500",
				Reasoning: "Environmental topics",
		...
		},
		{
			...
			input: commands.ToAny(commands.NewCommand[UpdateCodePayload, any](UpdateCode, UpdateCodePayload{
				Color:     "emerald-600",
				Reasoning: "Updated environmental coverage",
			}, EntityName, "code-123", nil)),
			expectErr: "",
			expectEvent: commands.ToAny(commands.NewDomainEvent[UpdatedCodePayload, any](UpdatedCode, UpdatedCodePayload{
				Color:     "emerald-600",
				Reasoning: "Updated environmental coverage",
			}, EntityName, "code-123", nil)),
		},
		...
		{
			name:        "DeleteCode",
			input:       commands.ToAny(commands.NewCommand[any, any](DeleteCode, nil, EntityName, "code-999", nil)),
			expectErr:   "",
			expectEvent: commands.ToAny(commands.NewDomainEvent[any, any](DeletedCode, nil, EntityName, "code-999", nil)),
		},
		{
		...
		},
		{
			...
			input: commands.ToAny(commands.NewDomainEvent[CreateCodePayload, any](CreateCode, CreateCodePayload{
				ProjectID: "project-1",
				Slug:      "topic:test",
				Color:     "blue",
				Reasoning: "Test",
		...
		},
		{
			...
			input: commands.ToAny(commands.NewCommand[CreateCodePayload, any]("DifferentAction", CreateCodePayload{
				ProjectID: "project-1",
				Slug:      "topic:test",
				Color:     "blue-500",
				Reasoning: "Test",
