...
func BuildTestProjectWithData() Project {
	...
	file1.Chunks = []file.Chunk{
		file.BuildTestChunk("1", "First chunk content", []file.CodedSection{
		...
		file.BuildTestChunk("2", "Second chunk content", []file.CodedSection{
	...
	file2.Chunks = []file.Chunk{
		file.BuildTestChunk("1", "Another chunk", []file.CodedSection{
