...
func TestCalculateChunkCoverage(t *testing.T) {
	chunk := file.Chunk{
		...
		Codes: []file.CodedSection{
			...
			{StartIndex: 15, EndIndex: 22, CodeSlug: "emotion:concern", CodeID: "code-2", CodedSectionAttributes: file.CodedSectionAttributes{Text: "impacts"}},
			{StartIndex: 23, EndIndex: 38, CodeSlug: "topic:temperature", CodeID: "code-3", CodedSectionAttributes: file.CodedSectionAttributes{Text: "global warming"}},
		},
	}
